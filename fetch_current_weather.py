...
# Define the API endpoint and parameters for current data (forecast)
url = "https://api.open-meteo.com/v1/forecast"  # Use the forecast endpoint for current data
...
hourly_dataframe.to_csv('cairo_current_weather.csv', index=False)
